// Representative coordinates [lat, lon] per IANA zone, generated from the
// tz database's zone.tab (the principal city of each zone). Used only for
// sunrise/sunset shading on the slider page; zones without an entry
// (UTC, Etc/*) get no night shading.
export const ZONE_COORDS = {
  ...
  'America/Coral_Harbour': [8.97, -79.53],
  'America/Cordoba': [-31.4, -64.18],
  ...
  'Asia/Rangoon': [16.78, 96.17],
  'Asia/Riyadh': [24.63, 46.72],
  'Asia/Saigon': [10.75, 106.67],
  ...
  'US/Mountain': [39.74, -104.98],
  'US/Pacific': [34.05, -118.24],
};

export function zoneCoords(zone) {
